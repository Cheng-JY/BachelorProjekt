import torch  # we import torch to creat tensors to store all of numerical values
import torch.nn as nn  # to make the weight and bias tensor part of the neural network
